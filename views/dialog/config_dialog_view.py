...
class ScrollMenuHandler:
    def __init__(self, config: Optional[AppConfig]):
        ...
        self.__timer_config_menu_handler: Final[TimerConfigMenuHandler] = TimerConfigMenuHandler(
            all_settings["preset_index_settings"]["preset_index"], all_settings["timer_settings_list"]
        )
    ...
    def change_current_menu_handler(self, configuration_item) -> None:
    ...
    def get_current_view_class(self):
        return self.__current_menu_handler.get_view_instance()

    def get_scroll_view_size(self, extension=0):
        current_view_class = self.get_current_view_class()
        return current_view_class.width, current_view_class.height + extension

    def get_all_setting_values(self):
        self.__current_menu_handler.write_out_field_inputs()
    ...
    def set_default_settings_inputs(self):
    ...
    def switch_view_enabled(self, will_enabled):
        ...
        for subview in self.get_current_view_class().subviews:
...
class ConfigDialogViewManager:
    ...
    def set_scroll_config_menu(self, configuration_item):
        ...
        self.__view_instance["config_menu_scroll"].add_subview(self.__scroll_menu_handler.get_current_view_class())

    def initiate_segmented_control(self):
    ...
    def swipe_scroll_config_menu(self, _=None):
        self.__view_instance["config_menu_scroll"].remove_subview(self.__scroll_menu_handler.get_current_view_class())
    ...
    def get_scale_factor(self, frame_height):
    ...
    def adjust_layout_for_keyboard_height(self, padding_of_keyboard):
        ...
        self.__view_instance["config_menu_scroll"].content_size = self.__scroll_menu_handler.get_scroll_view_size(
            extension_of_contents)

    def set_button_action(self, save_config_action, set_default_action, cancel_configuration_action):
