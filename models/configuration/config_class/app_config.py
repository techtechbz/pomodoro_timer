...
class AppConfig:
	def __init__(self, preset_index_settings, timer_settings_list, alarm_settings, task_recorder_settings, music_player_settings):
		self.__preset_index = preset_index_settings["preset_index"]
		self.__timer_config_list = [TimerConfig(**settings) for settings in timer_settings_list]
		self.__task_recorder_config = TaskRecorderConfig(**task_recorder_settings)
		self.__alarm_config = AlarmConfig(**alarm_settings)
		self.__music_player_config = MusicPlayerConfig(**music_player_settings)
	...
	def set_preset_index(self, preset_index) -> None:
